...

{
    ...
    echo "      NETWORK_ADAPTER: $(df --human-readable --block-size G /tmp | grep '/tmp' | awk '{print $4}')"
    ...
    echo "      GPU_DEVICE: /dev/dri/renderD128"
    echo "      QEMU_GPU: virtio-gpu-gl"
    ...
    echo "      - /dev/net/tun"
    echo "      - /dev/vhost-net"
    echo "      - /dev/dri/renderD128:/dev/dri/renderD128"
    echo "    cap_add:"
    echo "      - ALL"
    echo "    security_opt:"
